...
alternate_df <- full_dataframe %>%
  select(filename, code, totalTime, number_transits, scorer, half, experiment,fishID, largeMalePosition, prePost) %>%
...
```{r}
write_csv(alternate_df, 'alternate_df_matechoice_ys.csv')
```
